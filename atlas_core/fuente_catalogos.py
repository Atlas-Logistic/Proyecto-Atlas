...
def resolver_fuente_catalogos(
    ...
    if valor in (None, ""):
        # Compatibilidad segura para ejecuciones locales históricas: la carpeta
        # predeterminada solo cuenta como producción si contiene los siete
        # nombres canónicos. Los archivos *.example.json nunca satisfacen esto.
        predeterminada = Path("catalogos")
