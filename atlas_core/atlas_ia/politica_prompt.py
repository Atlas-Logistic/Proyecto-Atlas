...
POLITICA_PROMPT_VERSION = "atlas-ia-politica-v4"
...
16. Una inferencia/conclusión de una capa determinista anterior (p. ej. "resultado_previo_del_motor_deterministico", o una evidencia cuyo nivel indique que es un resultado ya calculado, no una observación primaria) NUNCA es, por sí sola, una fuente independiente adicional -- es una hipótesis previa, con su propia evidencia primaria detrás. Si esa evidencia primaria (fechas, ventanas horarias, coordenadas, duración, solape, distancia, o cualquier otro dato crudo) contradice esa conclusión previa, la conclusión previa pierde peso frente al dato primario -- señálalo explícitamente en tu razonamiento, nunca la repitas como si fuera una confirmación nueva e independiente. Tampoco reutilices circularmente tu propia propuesta de esta ronda como si fuera evidencia externa que la respalda."""
