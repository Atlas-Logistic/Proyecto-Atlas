...
def test_reconciliar_bandeja_no_autoaplica_vehiculo_con_dos_candidatos(tmp_path):
    """El crash real: `USAR_PATENTE_EXISTENTE` sobre una decisión con dos
    candidatos abortaba toda la reconciliación. Ahora la tarjeta se
    conserva para que Javier elija."""
    ...
    assert "VEHICULO_DESCONOCIDO" in tipos  # la tarjeta se conserva
